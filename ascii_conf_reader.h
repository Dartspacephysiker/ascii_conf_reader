/* 
     ...
     ascii_conf_reader.h - A bunch of C macros to facilitate reading ASCII .conf files.
                      I need to make an ascii_conf_reader_example.c file so you can see
                      how slick this is.
...
#ifndef _ASCII_CONF_READER
#define _ASCII_CONF_READER
...
#define  ASCII_R_DEBUG            0  /*Turn on debug to see what is read from the ASCII config file*/
...
#define READ_UINT_ARR_TO_STRUCT(pattern,pStruct,pauField,nArrElem)	\
	...
	iCnt = 0;							\
									\
	while ( ( getline(&szSubLine,(size_t *)&bufsize,psuASCIIConfFile) ) != -1 ) \
	    {								\
...
#endif //end #ifndef _ASCII_CONF_READER
